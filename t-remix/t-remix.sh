...
read answer
tput cup 12 22
echo -e "\e[104m Hello! WELCOME!! $answer! \e[m"
tput cup 15 0
echo -en "\e[93m IF YOU WANT TO HACK YOUR DREAM WORLD THEN JOIN ME (y/n)? \e[m "
read answer

if [ "$answer" != "${answer#[Yy]}" ] ;then
tput cup 17 21
    echo -e "\e[42m CONGRATULATIONS!!! YOU ARE A MEMBER OF DREAM_WORLD_HACKER \e[m"
else
tput cup 17 23
