...
######################################
#        PROJECT: t-remix               #
#        Author: CHAND M WAGHMARE       #
#        Email: cwaghmare101@gmailcom   #
######################################
echo -e "\e[32m[*]\e[34m WELCOME TO DREAM WORLD  \e[m "
echo
...
echo "
        ...
        WELCOME TO DREAM_WORLD_HACKERS_FAMILY.....
...
echo -e "\033[1;33m[*]system is ok -- CHECKED BY CHAND WAGHMARE \e[m "
echo -e "\033[1;33m[*]setting termux as a real hacker \e[m"
echo -e "\033[1;33m[*]LET'S FUN WITH LIFE \e[m "
echo FINISHED !
echo -e "\033[1;32m                                                             
﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌ \033[m "
sleep 4.0
...
tput cup 15 0
echo -en "\e[93m IF YOU WANT TO HACK YOUR DREAM WORLD THEN JOIN US (Y/N)? \e[m "
read answer

if [ "$answer" != "${answer#[Yy]}" ] ;then
tput cup 17 21
    echo -e "\e[42m CONGRATULATIONS!! YOU ARE A MEMBER OF DREAM_WORLD_HACKERS_FAMILY!! \e[m"
else
tput cup 17 23
    echo -e "\x1b[41m BE A WARRIOR NOT A WORRIER! \x1b[m"
fi
tput cup 20 0
figlet -f slant "LUCK DOESN'T EXIST BUT HARDWORK DOES..." |lolcat
echo " "
echo " "
